...
(function (ns) {
  ...
  const I18N = {
    ru: {
      meta: {
        title: 'Ключи от города — встреча в аэропорту, трансферы и экскурсии в Сочи',
        description:
          'Встретим в аэропорту Сочи с табличкой, довезём до отеля и покажем город. Фиксированная цена, ожидание рейса включено, водители говорят по-английски.',
      },
      ...
      services: {
        ...
        s1d:
          'Водитель стоит в зоне прилёта с табличкой и вашим именем. Рейс отслеживаем: задержали — ждём, прилетели раньше — тоже.',
        s1l1: 'Табличка с именем',
        s1l2: 'Помощь с багажом',
        s1l3: 'Сим-карта и вода в машине',
        s2t: 'Трансферы по городу',
        s2d:
          'Отель, вокзал, ресторан, Красная Поляна. Цена фиксируется при заказе и не растёт из-за пробок или ночного времени.',
      ...
      contacts: {
        ...
        lead:
          'Ответим в течение получаса и пришлём подтверждение с именем водителя. Ночью — утром, но встреча всё равно будет.',
        officeLabel: 'Офис',
    ...
    en: {
      meta: {
        title: 'City Keys — airport pickups, transfers and tours in Sochi',
        description:
          'We meet you at Sochi airport with a name sign, drive you to your hotel and show you the city. Fixed price, flight waiting included, English-speaking drivers.',
      },
      ...
      brand: {
        name: 'City Keys',
        sub: 'Sochi · pickups, transfers, tours',
      },
