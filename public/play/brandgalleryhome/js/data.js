/*
  ...
  Названия товаров и фабрик — настоящие, взяты из каталога действующего
  сайта. Всё остальное (цены, артикулы, сроки, размеры, материалы) —
  правдоподобные заглушки: этих полей на текущих карточках нет вообще,
  их предстоит заполнить заказчице. См. раздел 2 в docs/tz.md.

  Правило наличия из брифа: есть цена — товар в наличии у нас или на складе
  в Москве; нет цены — под заказ, цена по запросу.
*/
window.DEMO = (function () {
  'use strict';

  /* Наличие: 'krasnodar' — в зале, 'moscow' — склад в Москве,
     'order' — под заказ. У последнего цены нет по определению. */
  const P = [
    // ---------------------------------------------------------- гостиная
    ['Диван Gatsby', 'CAVIO CASA', 'gostinaya', 'divany', 940000, 'krasnodar', '', 'ткань, велюр', 'песочный', 'классический', '320 × 105 × 68'],
    ['Диван Sidney', 'Giorgio Casa', 'gostinaya', 'divany', 1180000, 'moscow', '', 'кожа', 'графитовый', 'современный', '280 × 98 × 72'],
    ...
    ['Буфет Rimini', 'CAVIO CASA', 'gostinaya', 'shkafy', 620000, 'moscow', '', 'массив ореха', 'орех', 'классический', '190 × 52 × 105'],
    ['Витрина Gatsby', 'CAVIO CASA', 'gostinaya', 'shkafy', null, 'order', '12–14 недель', 'массив, стекло', 'на выбор', 'классический', '110 × 45 × 200'],
    ['Буфет Chelsea', 'Giorgio Casa', 'gostinaya', 'shkafy', 780000, 'moscow', '', 'массив дуба', 'дуб', 'современный', '200 × 50 × 90'],
    ...
    // ----------------------------------------------------------- спальня
    ['Спальный гарнитур Nostalgia', 'CAVIO CASA', 'spalnya', 'krovati', 1650000, 'moscow', '', 'массив ясеня', 'слоновая кость', 'классический', '—'],
    ['Спальный гарнитур Torriani', 'Giorgio Casa', 'spalnya', 'krovati', null, 'order', '14–16 недель', 'массив', 'на выбор', 'классический', '—'],
    ['Спальный гарнитур Verdi', 'CAVIO CASA', 'spalnya', 'krovati', 1980000, 'moscow', '', 'массив, шпон', 'орех', 'классический', '—'],
    ['Кровать Sidney', 'Giorgio Casa', 'spalnya', 'krovati', 720000, 'krasnodar', '', 'кожа', 'песочный', 'современный', '180 × 200'],
    ['Кровать Casa dei Sogni', 'Giorgio Casa', 'spalnya', 'krovati', null, 'order', '12–14 недель', 'ткань', 'на выбор', 'современный', '160 × 200'],

    // ---------------------------------------------------------- столовая
    ['Стол Infinity Round', 'Giorgio Collection', 'stolovaya', 'stoly', 1450000, 'moscow', '', 'шпон, лак', 'графитовый', 'современный', 'Ø 150 × 75'],
    ...
    ['Стол Mirage', 'Giorgio Collection', 'stolovaya', 'stoly', 1120000, 'moscow', '', 'мрамор, металл', 'белый', 'современный', '220 × 110 × 75'],
  ...
  /* Фабрики для страницы фабрики. Тексты — заглушки под реальные,
     их предстоит написать. */
  const FACTORIES = {
